...
def save_seq_2_bvh(sequence, sequence_name,step=1):
    ...
    # filepath = os.getenv('Seq_AAE_V1')+'Training/Expr_Emilya/generation/'

    home_path = environ['HOME']
    home_path = home_path+'/Data Science/'
    project_path = home_path+'Seq_AAE_V1/'
    save_path = project_path
    filepath = save_path+'Training/Expr_Emilya/generation/'
